...
if (clientID > -1)
    ...
    [~, lidar1] = vrep.simxGetObjectHandle(clientID, 'fastHokuyo_sensor1', vrep.simx_opmode_streaming);
    [~, lidar2] = vrep.simxGetObjectHandle(clientID, 'fastHokuyo_sensor2', vrep.simx_opmode_streaming);
    
    % 측정된 데이터 받아오기
    [~, measuredData1] = vrep.simxGetStringSignal(clientID, 'measuredDataAtThisTime1', vrep.simx_opmode_streaming);
    [~, measuredData2] = vrep.simxGetStringSignal(clientID, 'measuredDataAtThisTime2', vrep.simx_opmode_streaming);
