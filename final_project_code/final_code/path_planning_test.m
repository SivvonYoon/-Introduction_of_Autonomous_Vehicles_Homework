...
if (clientID > -1)
    ...
    % obstacles' handle qkdrma 
    [~, chair1] = vrep.simxGetObjectHandle(clientID, 'diningChair', vrep.simx_opmode_blocking);
    [~, obstacle2] = vrep.simxGetObjectHandle(clientID, 'obstacle2', vrep.simx_opmode_blocking);
